...
```
npm install bitcore-lib-alarmx --save
npm install bitcore-payment-protocol-alarmx --save
```

For client-side projects:

```
bower install bitcore-lib-alarmx --save
bower install bitcore-payment-protocol-alarmx --save
```
